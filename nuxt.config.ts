  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'author', content: 'Codeshawk' },
        { name: 'robots', content: 'index, follow' },

        // Open Graph (Social Media)
        { property: 'og:type', content: 'website' },
        { property: 'og:title', content: 'Codeshawk - Creative Agency Portfolio' },
        ...
        { property: 'og:site_name', content: 'Codeshawk Portfolio' },

        // Twitter Card
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Codeshawk - Creative Agency Portfolio' },
